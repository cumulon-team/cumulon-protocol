  ...
  <div class="container">
    <div class="container-side">
      <div class="header">
        <router-link :to="{ name: 'home' }">
          <!-- <img class="icon" src="@/assets/images/home/Frame(1).png" alt="" />
           -->
          <img class="icon" src="@/assets/images/home/cumulon.png" alt="" />
        </router-link>
      </div>
      <router-link
        class="home-menu"
      ...
      <div class="menu-wrap">
        <a-tooltip
          ...
          v-for="(v, i) in menu"
          :key="i"
          content="Please select chain first"
        >
          <div
            v-if="!$store.state.global.currentChain.network"
            class="menu-item"
      ...
      <div
        v-if="
          $store.state.global.currentChain.symbols && $route.name !== 'home'
        "
        class="token-wrap"
      >
        <div class="token">
          Token：{{ $store.state.global.currentChain.symbols[0] }}
        </div>
      </div>
    </div>
    <div class="container-main">
      <div class="big-title">
        ...
        <div class="bt-right">
          <div class="doc hover-item">
            <img src="@/assets/images/home/doc.png" alt="" />
          </div>
          <a-button
            v-if="
  ...
  .container-main {
    ...
    .big-title {
      ...
      .doc {
        ...
        height: 56px;
        background: #ffffff;
        box-shadow: 4px 8px 40px 4px rgba(112, 144, 176, 0.08);
        border-radius: 50%;
        display: flex;
        justify-content: center;
        align-items: center;
