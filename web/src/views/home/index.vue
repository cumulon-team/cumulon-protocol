  ...
  <div class="home-page">
    <div class="banner" v-if="!$store.getters.ifLogin" @click="goSignIn">
      <div class="left">
        ...
        <div class="sub-title">
          Support {{ supportChainList.map((v) => v.chainId).join("; ") }}
        </div>
      </div>
      ...
      <div class="base-info section">
        ...
        <div class="section-content">
          ...
          >
            ...
            <img
              @click="
                $utils.copy($store.getters.polkadotWalletTransformAddress)
              "
              class="copy hover-item"
              src="@/assets/images/home/copy.png"
              alt=""
        ...
        <div class="section-content">
          ...
          >
            <div v-for="(sv, si) in getNetworkRow(i)" :key="si" class="item">
              ...
              <div class="num">
                {{ sv.free == undefined ? "--" : $utils.roundNumber(sv.free) }}
              </div>
              <div class="tag-wrap">
                <div
                  class="tag"
...
export default {
  ...
  computed: {
    supportChainList() {
      console.log('111',this.$store.state.global.supportChainList);
