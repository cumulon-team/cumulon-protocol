  ...
  <div class="moobeam-leaderboard-page">
    <div class="info-wrap">
      ...
      <div class="item">
        ...
        <div class="right">
          ...
          <div class="value">
            {{ $utils.roundNumber(latestBlockNumber, 0) }}
          </div>
        </div>
      </div>
      <div class="item">
    ...
    <div class="main">
                  ...
                  <template #default="{ identity }">
                    ...
                    <div class="middle">
                      ...
                      <div class="mb">
                        ...
                        <span v-if="ifStaked(v)" class="delegate"
                          >Delegated</span
                        >
                      </div>
                    </div>
      ...
      <Table
        ...
        :ifStaked="ifStaked"
        @updateMyStakeList="getMyStakeList"
      />
    </div>
  </div>
</template>
