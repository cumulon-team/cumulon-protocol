    ...
    <div class="table-wrap">
      <el-table :data="tableData">
        ...
        <el-table-column label="Amount" min-width="120">
          <template #default="scope">
            {{ $utils.roundNumber(scope.row.balance, 4) }}
          </template>
        </el-table-column>
  ...
  methods: {
    ...
    getTableData() {
      ...
      getDelegatorRewardHistory({
        ...
        delegatorAccount: this.$store.getters.currentChainWalletAddress,
        collator: this.selectCollator,
        roundindex: this.selectRound,
      }).then((d) => {
        this.loading = false;
